...
sed 's/Invurie/Inverurie/g' 2022_02_14-RNA_Monitoring_Project.csv | sed 's/Langhlm/Langholm/g' | sed 's/Philiphill/Philipshill/g' | sed 's/Sheildhall/Shieldhall/g' | sed 's/Stevenson/Stevenston/g' |  grep -v "Site" | sort -t, -k2 > 2022_02_14-RNA_Monitoring_Project_1.csv
