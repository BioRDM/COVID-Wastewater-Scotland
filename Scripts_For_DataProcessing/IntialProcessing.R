...
Data$Date_collected<- dmy(Data1$Date_collected) #Change the date format to YYYY-MM-DD
Data$Date_analysed<- dmy(Data1$Date_analysed)   #Change the date format to YYYY-MM-DD
write.csv(Data1,file="data_renamed.csv",quote = FALSE)
