...
Data = read.table("/home/sbaby/Desktop/Latest_data/sample.csv", header =TRUE, sep = ",", row.names = 1)
...
col_fun = colorRamp2(c(0,658,1316,11386), c("yellow", "purple","orange", "blue"))
...
pdf("Covid_Virus-2.pdf", width = 16, height = 15)
