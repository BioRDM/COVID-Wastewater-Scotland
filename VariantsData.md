...
This project used three approaches for detection and quantification of new SARS2 variants in wastewater: RT-qPCR, droplet digital PCR (ddPCR) and next generation sequencing (NGS). 
