...
sed 's/Invurie/Inverurie/g' ../../data/org_sepa_data/2022_02_14-Sites_population.csv| sed 's/Langhlm/Langholm/g' | sed 's/Philiphill/Philipshill/g' | sed 's/Sheildhall/Shieldhall/g' | sed 's/Stevenson/Stevenston/g' | sed 's/hatton - Fintry West/Hatton - Fintry West/g' | sed 1i"Highland,Dunoon,4k - 10k,7830\nLothian,Haddington,4k - 10k,9130\nBorders,Jedburgh,2k - 4k,3910\nHighland,Oban,4k - 10k,8490" | grep -v "Site" | sort -t, -k2   > intermediate/2022_02_14-Sites_population_1.csv
